...
public class MessageStatus  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this MessageStatus.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this MessageStatus.
     * 
     * @param id
     */
    ...
    /**
     * Gets the recipients value for this MessageStatus.
     * 
     * @return recipients
     */
    public RecipientStatus[] getRecipients() {
        return recipients;
    }


    /**
     * Sets the recipients value for this MessageStatus.
     * 
     * @param recipients
     */
    public void setRecipients(RecipientStatus[] recipients) {
        this.recipients = recipients;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(MessageStatus.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://onsetinc.com/OnPage/HUB/08/2011", "MessageStatus"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://onsetinc.com/OnPage/HUB/08/2011", "RecipientStatus"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
